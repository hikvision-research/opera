# dataset settings
dataset_type = 'opera.CrowdPoseDataset'
data_root = '/dataset/crowdpose/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        datasets=[
            dict(
                type=dataset_type,
                ann_file=data_root + 'annotations/json/crowdpose_train.json',
                img_prefix=data_root + 'images/',
                pipeline=train_pipeline),
            dict(
                type=dataset_type,
                ann_file=data_root + 'annotations/json/crowdpose_val.json',
                img_prefix=data_root + 'images/',
                pipeline=train_pipeline)
        ]),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/json/crowdpose_test.json',
        img_prefix=data_root + 'images/',
